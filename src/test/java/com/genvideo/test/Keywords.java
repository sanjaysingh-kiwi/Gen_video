...
public class Keywords {
   ...
   //public  AppiumDriver<MobileElement> driver1;
    ...
    /*public  String LaunchApplication(String object,String data) throws IOException, InterruptedException{
		APP_LOGS.debug("Executing LunchApplication");
			...
			//AppiumDriverLocalService service = AppiumDriverLocalService.buildDefaultService();
	 	    //service.start();
	 	    //Thread.sleep(25000L);	
				Runtime.getRuntime().exec("open -a Terminal /Users/kiwitech/Downloads/Selenium30_sept_2015/startappium.command");
		        Thread.sleep(25000L);
				//File appDir = new File ("/Users/kiwitech/Desktop/apk");
				...
				//capabilities.setCapability("udid","6d4e9b4d63092e8cd77e44ab13ee26399cf43866");
				//capabilities.setCapability("udid","b251c1abdffdc25a7010f0e86bf7864c8a132662");
			    //capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iphone05");
			    capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iPhone 6");
				capabilities.setCapability(MobileCapabilityType.BROWSER_NAME, "");
				//capabilities.setCapability("bundleID","com.kiwitech.mahaalo");
				capabilities.setCapability(MobileCapabilityType.APP,app.getAbsolutePath());
				driver1  = new IOSDriver<MobileElement>(new URL("http://127.0.0.1:4723/wd/hub") , capabilities);
    ...
    public  String selectList(String object, String data){
        ...
        try{
            if(!data.equals(Constants.RANDOM_VALUE)){
                ...
                List<WebElement> droplist_cotents = droplist.findElements(By.tagName("EXPO"));
...
//        	driver.findElement(By.xpath("html/body/div[1]/div[2]/div/div/div[3]/div[1]")).click();
        	Select dropdown = new Select(driver.findElement(By.xpath("html/body/div[1]/div[2]/div/div/div[3]/div[1]/select")));
        	...
        	List<WebElement> list = driver.findElements(By.className("ng-valid"));
...
//        	driver.findElement(By.xpath("html/body/div[1]/div[2]/div/div/div[3]/div[2]")).click();
        	Select dropdown = new Select(driver.findElement(By.xpath("html/body/div[1]/div[2]/div/div/div[3]/div[2]/select")));
    ...
    public  String groupDropList(String object, String data){
        ...
        try {
        	Select dropdown = new Select(driver.findElement(By.xpath("html/body/div[1]/div[2]/div/div/div[3]/div[3]/select")));
        	dropdown.selectByIndex(1);
        	Thread.sleep(5000);
//        	driver.findElement(By.className("hasCustomSelect")).sendKeys("Admin");
//        	driver.findElement(By.className("hasCustomSelect")).click();
//        	
//            List<WebElement> list = driver.findElements(By.className("customLoginSelect"));
//           for(int i=0;i<list.size();i++){
//            	System.out.println(list.get(i).getText());
//            	            	
//            }
    ...
    public  String selectactive(String object, String data){
        ...
        try {
        	driver.findElement(By.xpath(".//*[@id='engagement-orders-builder']/div/div[3]/div/section[1]/div/div/form/div[2]/div[1]/div[5]/div/div/button")).click();  
        	driver.findElement(By.xpath(".//*[@id='engagement-orders-builder']/div/div[3]/div/section[1]/div/div/form/div[2]/div[1]/div[5]/div/div/ul/li[2]/a")).click();
    ...
    public  String uploadcampaignimagenot(String object, String data){
        ...
        try{
        	WebElement upload = driver.findElement(By.xpath(".//*[@id='wrap']/div/div[1]/div/div/div/div/div[2]/div[2]/div/div[1]/form/div[1]/div/div/div/div/ng-form/div[4]/image-upload"));
        	upload.click();
...
//        	upload.sendKeys("/Users/kiwitech/Desktop/test.jpg");
    ...
    public  String uploadcampaignimagenot1(String object, String data){
        ...
        try{
        	...
        	upload.click();
        	Thread.sleep(5000l);
        	StringSelection ss = new StringSelection("C:\\Users\\user\\Desktop\\test1.jpg");
    ...
    public  String uploadcampaignimage1(String object, String data){
        ...
        try{
        	...
        	upload.click();
        	Thread.sleep(5000l);
        	StringSelection ss = new StringSelection("C:\\Users\\user\\Desktop\\test.jpg");
        	Toolkit.getDefaultToolkit().getSystemClipboard().setContents(ss, null);
    ...
    public  String expdate(String object, String data){
        ...
        try {
           driver.findElement(By.xpath("addnewOrder_expdate")).sendKeys("2016-06-30");
...
*/
    ...
    public  String pickerwheel(String object,String data){
		...
		try{
			driver.findElement(By.xpath(OR.getProperty(object))).sendKeys(data + "\n");
				...
				// report error
				return Constants.KEYWORD_FAIL+" -- Not able to enter picker wheel keyword";
			}
    ...
    public  String ExplicitWait(String object,String data) throws NumberFormatException, InterruptedException{
    ...
    public  String Enterproductiphone(String object,String data){
        ...
        try{
           driver.findElement(By.xpath(".//*[@id='searchInput']")).sendKeys("iPhone");
           Thread.sleep(5000l);
...
public String closeApp(String object,String data){
		APP_LOGS.debug("Executing closeApp Keyword");
		try{
...
public  String launchApp(){
   ...
   public String scrollTo(String object,String data){
		APP_LOGS.debug("Executing scrollTo Keyword");
...
*/
    public  String gmailwindow(String object,String data){
        ...
        try{
        	...
        	driver.findElement(By.cssSelector("#Email")).sendKeys("genvideotest5@gmail.com"); 
        	driver.findElement(By.cssSelector("#next")).click();
        	driver.findElement(By.cssSelector("#Passwd")).sendKeys("genvideotest"); 
        	driver.findElement(By.cssSelector("#signIn")).click(); 
        	Thread.sleep(10000l);
        	driver.findElement(By.cssSelector("#submit_approve_access")).click();  
...
//        	driver.close(); // close newly opened window when done with it
        	...
        	driver.switchTo().window(parentHandle); // switch back to the original window
        	Thread.sleep(10000l);
            driver.findElement(By.xpath("html/body/div[2]/div/div/div/div/div/div[3]/div[2]/div/button[2]")).click();         
        }catch(Exception e){
            return Constants.KEYWORD_FAIL+" Unable to write "+e.getMessage();
