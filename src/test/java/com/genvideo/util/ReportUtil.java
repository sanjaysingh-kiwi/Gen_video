...
import com.genvideo.test.Constants;
import com.genvideo.xls.read.Xls_Reader;
...
public class ReportUtil {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//test//java//com//genvideo//config//config.properties");
        ...
        try{
            ...
            out.write("<html><HEAD> <TITLE>Automation Test Results</TITLE></HEAD><body><h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> Gen Video Automation Test Results</u></b></h4><table  border=1 cellspacing=1 cellpadding=1 ><tr><h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> <u>Test Details :</u></h4><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Run Date</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
            ...
            for(int currentSuiteID =2;currentSuiteID<= totalTestSuites;currentSuiteID++){
                ...
                current_suite_xls=new Xls_Reader(System.getProperty("user.dir")+"//src//test//java//com//genvideo//xls//"+currentTestSuite+".xlsx");
